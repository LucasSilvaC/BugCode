...
// Para exibir o alerta IF
function exibirAlertaIf() {
    const idade = document.getElementById("answer_alert_if").value;
...
// Para exibir o alerta ELSE IF
function exibirAlertaElseIf() {
    const idade = document.getElementById("answer_alert_elseif").value;

    if (idade > 18) {
    alert("Você é maior de idade.");}
    else if(idade == 18){
    alert("Você acabou de se tornar maior de idade.");}
    }

// Para exibir o alerta ELSE 
function exibirAlertaElse() {
    const idade = document.getElementById("answer_alert_else").value;
